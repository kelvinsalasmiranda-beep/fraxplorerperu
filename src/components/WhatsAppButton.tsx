          ...
          >
            ...
            <div className="p-4 space-y-2">
              <a
                ...
                className="flex items-center gap-3 rounded-2xl bg-green-50 p-3 text-sm font-medium text-green-800 hover:bg-green-100 transition"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-green-500 text-white text-xs">1</span>
                +51 931 536 444
              </a>
              <a
                ...
                className="flex items-center gap-3 rounded-2xl bg-green-50 p-3 text-sm font-medium text-green-800 hover:bg-green-100 transition"
              >
                <span className="flex h-8 w-8 items-center justify-center rounded-full bg-green-500 text-white text-xs">2</span>
                +51 900 567 224
              </a>
            </div>
          </motion.div>
